...
| 4 | DuplicateIdDetected | system | file scan, not index | maintenance_service.py:600 (`_find_duplicate_ids`) |
...
| 7 | AdvisoryLinted | ACT-002 | `docir lint --deep` | maintenance_service.py:638 (`lint_deep`) |
