...
- cli
- docs
title: 'ADR-0017: The site publishes the relation graph as an interactive constellation
  page'
type: decision
updated: '2026-08-04'
---

# ADR-0017: The site publishes the relation graph as an interactive constellation page

Status: accepted
Date: 2026-08-04

## Context
`docir build` (ADR-0016) publishes one page per document plus an index. The
