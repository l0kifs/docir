...
- architecture
- agents
title: 'ADR-0013: MCP as a second transport over the dispatcher'
type: decision
updated: '2026-08-03'
---

# ADR-0013: MCP as a second transport over the dispatcher
...
(ADR-0008) covers assistants that run shell commands — it teaches Claude Code or
