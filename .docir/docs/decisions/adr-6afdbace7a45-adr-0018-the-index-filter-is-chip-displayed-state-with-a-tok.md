...
- cli
- docs
title: 'ADR-0018: The index filter is chip-displayed state with a token grammar'
type: decision
updated: '2026-08-05'
---

# ADR-0018: The index filter is chip-displayed state with a token grammar
...
ADR-0016 gave the published index faceted filters: type/status/updated
...
- The filter script roughly doubles, but remains dependency-free, inline and
  offline-complete; nothing about ADR-0016's self-containment moves.
