...
- schema
- cli
title: 'ADR-0010: A qa profile, a release_note type, and schema introspection'
type: decision
updated: '2026-07-30'
---

# ADR-0010: A `qa` profile, a `release_note` type, and schema introspection
Status: accepted
Date: 2026-07-26
...
**1. An agent cannot author a schema.** The bundled agent skill (ADR-0008) told
...
`init` / `agent` / `version` precedent (ADR-0008, ADR-0009) — they touch no
