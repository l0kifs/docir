...
- embeddings
- architecture
title: 'ADR-0015: Cross-encoder reranking, built and rejected on measurement'
type: decision
updated: '2026-08-03'
---

# ADR-0015: Cross-encoder reranking, built and rejected on measurement
...
lexical index and per-section vectors (ADR-0014) already places the right
...
- **The precedent is ADR-0011 run the other way.** There, measurement
