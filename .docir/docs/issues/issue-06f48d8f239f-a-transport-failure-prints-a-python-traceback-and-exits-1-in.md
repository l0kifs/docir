...
- daemon
- material
title: A transport failure prints a Python traceback and exits 1 instead of the error
  it raised
type: issue
updated: '2026-08-05'
---
...
**Flow:** arch-3e305bc76ff0/arch-f220a644d654 (every command dispatched over the daemon)
...
It also undoes the message written for issue-d79dbf1075fa four commits earlier: the escape hatches it
