...
- schema
- material
title: GAP-014 — `--override` bypasses the transition rules and leaves no trace
type: issue
updated: '2026-07-30'
---

# GAP-014 — `--override` bypasses the transition rules and leaves no trace

**Class:** missing · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-001 · **Step:** --override on an illegal status transition
**Question:** Q-014 · **Frequency:** unknown
