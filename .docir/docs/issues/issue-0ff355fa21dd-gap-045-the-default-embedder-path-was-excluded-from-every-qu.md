...
- embeddings
- material
title: GAP-045 — The default embedder path was excluded from every quality gate
type: issue
updated: '2026-07-30'
---

# GAP-045 — The default embedder path was excluded from every quality gate

**Class:** unstated · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-002 · **Step:** the gates, once fastembed became the default
