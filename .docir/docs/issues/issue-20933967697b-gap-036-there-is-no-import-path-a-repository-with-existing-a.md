...
- integrity
- material
title: GAP-036 — There is no import path. A repository with existing ADRs must create
  each document…
type: issue
updated: '2026-07-30'
---

# GAP-036 — There is no import path. A repository with existing ADRs must create each document…

**Class:** missing · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-004 · **Step:** adopting docir in a repo that already has documents
**Question:** Q-012 · **Frequency:** once per adopting repository, at the moment of adoption
