...
- schema
- material
title: Q-010 — Should `schema validate` check that transition targets and `inactive_statuses`
  name…
type: issue
updated: '2026-07-30'
---

# Q-010 — Should `schema validate` check that transition targets and `inactive_statuses` name…

**Gap:** GAP-010 · **Also resolves:** — · **Audience:** repo maintainer
**Blocking:** no · **Rank:** 10 · **Asked:** — · **Answered:** 2026-07-28
