...
- cli
- material
title: GAP-023 — Commands run in an uninitialised repository silently fall back to
  the global `~/.docir`…
type: issue
updated: '2026-07-30'
---

# GAP-023 — Commands run in an uninitialised repository silently fall back to the global `~/.docir`…

**Class:** misleading · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-004 · **Step:** running a command before docir init
**Question:** Q-016 · **Frequency:** any user who forgets `docir init` — the second step of the quickstart
