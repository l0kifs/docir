...
**Flow:** arch-0a3c2d6d54a6 · **Step:** after check reports a problem
**Question:** issue-0a4ad65b8a70 · **Frequency:** whenever issue-b7ddde3ce860 or issue-389dc5dac58a fires
...
Every confirmed failure mode in this run (issue-b7ddde3ce860, issue-fd547a293d01, issue-389dc5dac58a) terminates in a state the product detects and cannot exit. That is also in direct tension with thesis #2, "agents never edit markdown directly" — recovery *requires* exactly that.
