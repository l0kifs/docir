...
- integrity
- material
title: GAP-022 — `reindex` silently skips files that fail to parse and reports only
  `documents_indexed`,…
type: issue
updated: '2026-07-30'
---

# GAP-022 — `reindex` silently skips files that fail to parse and reports only `documents_indexed`,…

**Class:** misleading · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-003 · **Step:** reindex over a corpus containing a malformed file
