...
- integrity
- material
title: GAP-016 — The rule "agents never edit markdown directly" is stated for agents
  but the boundary…
type: issue
updated: '2026-07-30'
---

# GAP-016 — The rule "agents never edit markdown directly" is stated for agents but the boundary…

**Class:** unstated · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-001 · **Step:** hand-editing a markdown file
...
Hand-editing works and is expected. A hand-edit that breaks frontmatter is silently dropped from the corpus (GAP-022). A hand-edit that duplicates an id is caught only by `check`. Which fields are safe to edit by hand (body: yes; id: never; related: only with care) is nowhere written.
