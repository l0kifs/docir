...
- agents
- material
title: GAP-040 — The canonical agent instructions told agents to run `docir reindex
  --all`, a flag that…
type: issue
updated: '2026-07-30'
---

# GAP-040 — The canonical agent instructions told agents to run `docir reindex --all`, a flag that…

**Class:** incorrect · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-004 · **Step:** the packaged agent guide (`modules/agents/infra/templates/skill.md`)
