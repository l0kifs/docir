...
- cli
- cosmetic
title: GAP-034 — An edge's target key is `to` in frontmatter and `target` in JSON
  output
type: issue
updated: '2026-07-30'
---

# GAP-034 — An edge's target key is `to` in frontmatter and `target` in JSON output

**Class:** misleading · **Severity:** cosmetic · **Confidence:** observed
**Flow:** FLOW-001 · **Step:** reading a relation in two representations
