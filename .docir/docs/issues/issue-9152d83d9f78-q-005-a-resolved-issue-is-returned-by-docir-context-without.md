...
- retrieval
- blocking
title: Q-005 — A `resolved` issue is returned by `docir context` without `--include-resolved`,
  because…
type: issue
updated: '2026-07-30'
---

# Q-005 — A `resolved` issue is returned by `docir context` without `--include-resolved`, because…

**Gap:** GAP-004 · **Also resolves:** — · **Audience:** repo maintainer
