...
- retrieval
- material
title: Q-009 — Should `docir context` be able to return nothing? There is no similarity
  floor, and the…
type: issue
updated: '2026-07-30'
---

# Q-009 — Should `docir context` be able to return nothing? There is no similarity floor, and the…

**Gap:** GAP-017 · **Also resolves:** — · **Audience:** repo maintainer
**Blocking:** no · **Rank:** 9 · **Asked:** — · **Answered:** 2026-07-28
