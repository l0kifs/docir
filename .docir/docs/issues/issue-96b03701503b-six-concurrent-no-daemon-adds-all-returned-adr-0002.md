...
ANSWERED 2026-07-26 by implementation: allocation is now atomic in both modes via a single upsert statement. `--no-daemon` is safe for parallel writers. CLAUDE.md updated to state why the invariant holds. See issue-389dc5dac58a resolution.
