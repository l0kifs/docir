...
- retrieval
- blocking
title: GAP-005 — `--limit` bounds the ranked seed set but not the response
type: issue
updated: '2026-07-30'
---

# GAP-005 — `--limit` bounds the ranked seed set but not the response

**Class:** incorrect · **Severity:** blocking · **Confidence:** observed
**Flow:** FLOW-002 · **Step:** graph expansion after ranking
**Question:** Q-003 · **Frequency:** every `context` call against a corpus with relations
