...
Yes to a trace, no to a record: warn loudly, store nothing. The escape hatch is deliberate and stays; what was missing was telling the operator, at the moment of the bypass, which rule they broke. An `overridden:` frontmatter field was rejected — no actors to attribute it to (adr-90e994d931cc), git already records the status change, and it would be permanent schema surface. Dropping the flag was rejected too: a document stranded by a schema change would have no path out but hand-editing, which the issue-6817ed1851e2 contract forbids. See issue-0783d236d565 resolution.
