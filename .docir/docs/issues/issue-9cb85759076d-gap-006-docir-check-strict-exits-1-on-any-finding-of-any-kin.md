...
- integrity
- blocking
title: GAP-006 — `docir check --strict` exits 1 on any finding of any kind, and `orphan`
  fires for every…
type: issue
updated: '2026-07-30'
---

# GAP-006 — `docir check --strict` exits 1 on any finding of any kind, and `orphan` fires for every…

**Class:** misleading · **Severity:** blocking · **Confidence:** observed
**Flow:** FLOW-003 · **Step:** CI gate
**Question:** Q-004 · **Frequency:** first CI run of any adopting repo
