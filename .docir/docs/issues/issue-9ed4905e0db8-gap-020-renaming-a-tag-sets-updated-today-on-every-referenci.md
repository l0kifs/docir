...
- tags
- material
title: GAP-020 — Renaming a tag sets `updated = today` on every referencing document,
  which resets the…
type: issue
updated: '2026-07-30'
---

# GAP-020 — Renaming a tag sets `updated = today` on every referencing document, which resets the…

**Class:** incorrect · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-005 · **Step:** tag rename / tag rm --force
**Question:** Q-015 · **Frequency:** every tag rename, across every document carrying the tag
...
Launders the one trust signal the product offers. ADR-0006 argues staleness must be honest human re-verification; an administrative bulk edit silently forges it.
