...
- retrieval
- cosmetic
title: GAP-031 — Tags are neither in the FTS index nor in the embedded text, so `docir
  search auth` does…
type: issue
updated: '2026-07-30'
---

# GAP-031 — Tags are neither in the FTS index nor in the embedded text, so `docir search auth` does…

**Class:** unstated · **Severity:** cosmetic · **Confidence:** observed
**Flow:** FLOW-005 · **Step:** search for a tag name
