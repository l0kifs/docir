...
**Flow:** arch-90c90751344f · **Step:** docir schema validate
**Question:** issue-2b28fd8b1dfa · **Frequency:** any hand-edited schema with a typo — the case the command exists for
