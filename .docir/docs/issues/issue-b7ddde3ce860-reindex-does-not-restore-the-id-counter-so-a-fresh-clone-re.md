...
**Flow:** arch-0a3c2d6d54a6 · **Step:** reindex, then the next add
**Question:** issue-88dd653b9f39 · **Frequency:** once per fresh clone that then adds a document — i.e. every new contributor
