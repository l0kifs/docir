...
- persistence
- material
title: GAP-037 — Only `--replace-body` has a stale-write guard. Two concurrent metadata
  patches to the…
type: issue
updated: '2026-07-30'
---

# GAP-037 — Only `--replace-body` has a stale-write guard. Two concurrent metadata patches to the…

**Class:** unstated · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-001 · **Step:** two concurrent updates to the same document
