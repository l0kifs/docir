...
- integrity
- material
title: GAP-021 — `reindex --changed` skips the removal sweep entirely, so documents
  deleted from the…
type: issue
updated: '2026-07-30'
---

# GAP-021 — `reindex --changed` skips the removal sweep entirely, so documents deleted from the…

**Class:** unstated · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-003 · **Step:** reindex --changed
