...
- tags
- material
title: GAP-028 — Renaming a tag onto an existing key is rejected, so two tags cannot
  be merged
type: issue
updated: '2026-07-30'
---

# GAP-028 — Renaming a tag onto an existing key is rejected, so two tags cannot be merged

**Class:** missing · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-005 · **Step:** consolidating two tags
