...
FIXED 2026-07-29, and two-thirds of it incidentally. Sense (2), "changed on disk", became `disk_diverged` while stating issue-be95d3e242a3; sense (3), the orphaned index row, is now `orphaned` in the removal sweep. Sense (1) keeps the word, as proposed — it is the product feature.
