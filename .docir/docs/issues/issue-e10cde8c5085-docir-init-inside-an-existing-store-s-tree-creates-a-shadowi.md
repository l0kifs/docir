...
- cli
- material
title: '`docir init` inside an existing store''s tree creates a shadowing store in
  silence'
type: issue
updated: '2026-08-05'
---
...
**Flow:** arch-90c90751344f (adoption)
...
Not a contradiction of adr-20eec6e2e2ca. That decision says `new_store_home` deliberately does not
