...
- retrieval
- cosmetic
title: GAP-018 — `search` fetches `limit * 2` candidates then filters; if more than
  half are inactive it…
type: issue
updated: '2026-07-30'
---

# GAP-018 — `search` fetches `limit * 2` candidates then filters; if more than half are inactive it…

**Class:** unstated · **Severity:** cosmetic · **Confidence:** observed
**Flow:** FLOW-002 · **Step:** search with many inactive documents in the head of the ranking
