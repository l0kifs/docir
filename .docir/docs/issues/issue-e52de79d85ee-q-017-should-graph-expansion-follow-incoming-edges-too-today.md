...
- retrieval
- material
title: Q-017 — Should graph expansion follow incoming edges too? Today it is outgoing-only,
  so from a…
type: issue
updated: '2026-07-30'
---

# Q-017 — Should graph expansion follow incoming edges too? Today it is outgoing-only, so from a…

**Gap:** GAP-019 · **Also resolves:** — · **Audience:** repo maintainer
**Blocking:** no · **Rank:** 17 · **Asked:** 2026-07-27 · **Answered:** 2026-07-27
**Authority:** repo maintainer (directed the fix alongside Q-005)
...
Yes — expansion follows incoming `supersedes`/`contradicts` as well, and puts them ahead of outgoing links so a tight `--expand` budget spends itself on "what replaces this?" first. Outgoing-only was a simplification, not a decision. See GAP-019 resolution.
