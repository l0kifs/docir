...
- schema
- material
title: GAP-033 — The flag is `--include-resolved` but the concept is "inactive status",
  which is…
type: issue
updated: '2026-07-30'
---

# GAP-033 — The flag is `--include-resolved` but the concept is "inactive status", which is…

**Class:** misleading · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-002 · **Step:** asking for closed documents
