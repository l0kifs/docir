...
- integrity
- cosmetic
title: GAP-041 — `_restore_id_sequences` classifies an id as sequential by testing
  whether its suffix is…
type: issue
updated: '2026-07-30'
---

# GAP-041 — `_restore_id_sequences` classifies an id as sequential by testing whether its suffix is…

**Class:** incorrect · **Severity:** cosmetic · **Confidence:** observed
**Flow:** FLOW-003 · **Step:** reindex over a store using random ids
