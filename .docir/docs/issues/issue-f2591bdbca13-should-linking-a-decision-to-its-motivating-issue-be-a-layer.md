...
OBSERVED: `adr-0001 related: [issue-0003]` → "layering violation: decision 'adr-0001' depends on lower-level issue 'issue-0003'". This is the pairing shown in the README's own quickstart output (README:78-81). Evidence: profiles.py/44-46, graph_checks.py, :26.
