...
- integrity
- material
title: GAP-007 — `delete --force` leaves referencing documents pointing at a document
  that no longer…
type: issue
updated: '2026-07-30'
---

# GAP-007 — `delete --force` leaves referencing documents pointing at a document that no longer…

**Class:** missing · **Severity:** material · **Confidence:** observed
**Flow:** FLOW-001 · **Step:** delete --force, and every later write to a referencing document
**Question:** Q-007 · **Frequency:** every forced delete
