---
created: '2026-07-30'
description: The staged procedure an AI agent follows when reviewing new code.
id: run-22e0a6ce6ae1
owner: maintainer
related:
- ref-32cb4f874fbe
...
> **Maintainers**: QA Automation Team  
> **Status**: Active  
> **Summary**: Checklist for an AI agent reviewing or testing new code, structured as ordered focused passes rather than one general review. Covers change inventory, the input matrix, boundary value analysis, unhappy paths per operation, decision tables for multi-condition business rules, state transition checks, domain checklists for registration/login/API surfaces, test quality review, AI-generated-code failure modes, and a Definition of Done reporting gate. Grounded in ISTQB test design techniques, agile acceptance criteria practice, and OWASP input validation guidance.  
